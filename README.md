...
> **최신 버전: v1.9.0** — 대시보드 법령 개정정보 위젯(법제처 Open API·업종별 관련 법령), 법령 조회 기간 설정, 수탁사 선택(일괄) 삭제, 개인정보처리방침 일괄등록 최근 URL 이력, 보안이벤트 상태별 건수 오표시 수정 ([릴리즈 노트](release/v1.9.0/RELEASE_NOTES.md))
...
| 버전 | 주요 변경 |
|------|-----------|
| [v1.9.0](release/v1.9.0/RELEASE_NOTES.md) | 대시보드 법령 개정정보 위젯(법제처 Open API·업종별 관련 법령·12h 캐시), 설정관리 법령 조회 기간(프리셋 1주~12개월), 수탁사 선택(일괄) 삭제, 개인정보처리방침 일괄등록 최근 URL 이력(자동 채움), 보안이벤트 상태별 건수 오표시 수정(Spring page 직렬화 대응) |
