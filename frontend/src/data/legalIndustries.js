export const CATEGORIES = [
  { key: 'common',    label: '업종 공통',         color: 'bg-rose-100 text-rose-700' },
...
export const INDUSTRIES = [
  // ─────────────────────────────────────────────────────────────────
  // 업종 공통 — 모든 일반법인이 업종과 무관하게 공통 적용받는 법령
  // ─────────────────────────────────────────────────────────────────
  {
    id: 100,
    name: '일반법인 (전 업종 공통)',
    ...
    laws: [
      ...
      // 정보통신망법 관련 법령 및 고시
      { name: '정보통신망 이용촉진 및 정보보호 등에 관한 법률',                ministry: '과학기술정보통신부', type: '법령',    url: 'https://www.law.go.kr/법령/정보통신망이용촉진및정보보호등에관한법률' },
      { name: '정보통신망 이용촉진 및 정보보호 등에 관한 법률 시행령',          ministry: '과학기술정보통신부', type: '시행령',  url: 'https://www.law.go.kr/법령/정보통신망이용촉진및정보보호등에관한법률시행령' },
      { name: '정보통신망 이용촉진 및 정보보호 등에 관한 법률 시행규칙',        ministry: '과학기술정보통신부', type: '시행규칙', url: 'https://www.law.go.kr/법령/정보통신망이용촉진및정보보호등에관한법률시행규칙' },
      { name: '정보보호 및 개인정보보호 관리체계 인증 등에 관한 고시',          ministry: '과학기술정보통신부', type: '고시',    url: 'https://www.law.go.kr/행정규칙/정보보호및개인정보보호관리체계인증등에관한고시' },
      { name: '정보보호 조치에 관한 지침',                                     ministry: '과학기술정보통신부', type: '고시',    url: 'https://www.law.go.kr/행정규칙/정보보호조치에관한지침' },
    ]
  },
  ...
  },
  {
    ...
    category: 'other',
    laws: [
      { name: '인공지능 발전과 신뢰 기반 조성 등에 관한 기본법',                ministry: '과학기술정보통신부', type: '법령',    url: 'https://www.law.go.kr/법령/인공지능발전과신뢰기반조성등에관한기본법' },
      { name: '인공지능 발전과 신뢰 기반 조성 등에 관한 기본법 시행령',          ministry: '과학기술정보통신부', type: '시행령',  url: 'https://www.law.go.kr/법령/인공지능발전과신뢰기반조성등에관한기본법시행령' },
    ]
  },
]
