...
CREATE TABLE IF NOT EXISTS risk_assessments (
    ...
    asset_environment VARCHAR(50),
    threat_id     BIGINT,
    threat_name   VARCHAR(255),
    threat_type   VARCHAR(100),
    threat_category    VARCHAR(100),
    threat_asset_types VARCHAR(500),
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 재해복구(DR)·업무연속성(BCP) 훈련 (v1.55.0)
-- 시나리오 예제는 BcpScenarioInitializer(seed-when-empty)가 기동 시 채운다.
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 비상연락망 (v1.56.0)
-- 기본 연락 계통·외부기관 연락처는 EmergencyContactInitializer(seed-when-empty)가 채운다.
-- mobile·email 은 AES-256-GCM 암호문으로 저장된다.
-- ─────────────────────────────────────────────────────────────────────────────
