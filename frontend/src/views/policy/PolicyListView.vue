  ...
  <div class="p-8">
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex gap-2">
        ...
        <button v-if="isManager" @click="showDocModal = true"
          class="btn-secondary flex items-center gap-2 text-sm"
          title="지침 PDF·DOCX 를 올려 지침 > 장 > 조 구조로 자동 등록">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <template v-else>
    <PolicyDocumentImportModal
      v-if="showDocModal"
      @close="showDocModal = false"
      @imported="loadPolicies"
    />
...
import PolicyDocumentImportModal from './PolicyDocumentImportModal.vue'
