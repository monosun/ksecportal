...
> **최신 버전: v1.28.1** — SAST 오탐 2건 억제 주석 처리 ([릴리즈 노트](release/v1.28.1/RELEASE_NOTES.md)) · v1.28.0 목록 화면 개인정보 마스킹 적용·개인정보 컬럼 암호화 ([릴리즈 노트](release/v1.28.0/RELEASE_NOTES.md))
